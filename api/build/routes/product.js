...
const productValidator_1 = require("../validator/productValidator");
...
route.post('/add', productValidator_1.validateCreatingProduct, product_controller_1.createProductController);
